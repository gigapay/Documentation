...
| `latest_status`    | `created` - An employee record has been created<br>`not_invited` - The employee has not received any invitation yet<br>`invited` - An invitation has been sent to the employee<br>`onboarding` - The employee has accepted the invitation and is completing the onboarding process<br>`active` - employee has completed onboarding and is ready to receive payouts |
